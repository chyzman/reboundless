...
public class BindableType<T extends Bindable> {
    ...
    public static final SimpleRegistry<BindableType<?>> BINDING_TYPE_REGISTRY = new SimpleRegistry<>(BINDABLE_TYPE_KEY, Lifecycle.stable(), true);

    private final RegistryEntry.Reference<BindableType<?>> registryEntry = BINDING_TYPE_REGISTRY.createEntry(this);
